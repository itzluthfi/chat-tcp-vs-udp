  ...
  interface LoginProps {
    ...
    availableUsers: User[];
    onSwitchToRegister: () => void; // <--- TAMBAHAN BARU
  }
          ...
          >
            ...
            <form onSubmit={handleLogin} className="space-y-5">
              ...
              <div className="flex items-center">
                ...
                <label
                  htmlFor="remember-me"
                  className="ml-2 text-sm font-medium text-slate-400 cursor-pointer"
                >
                  Remember me
                </label>
              </div>
            ...
            <div className="text-center mt-6">
              ...
              <button
                ...
                className="mt-2 px-6 py-2 rounded-xl bg-slate-800 text-indigo-400 text-xs font-bold uppercase tracking-widest hover:bg-slate-700 transition-all border border-slate-700"
              >
                Create Account
              </button>
            </div>
            ...
            >
              <i
                className={`fas ${
                  showDemoPanel ? "fa-chevron-left" : "fa-bolt"
                }`}
              ></i>
              {showDemoPanel
                ? "Hide Demo Access"
